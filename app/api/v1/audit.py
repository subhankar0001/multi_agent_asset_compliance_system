...
Idempotency:
  Each request carries a ``run_id`` (generated by backend client).  Before executing
...
The backend client reads the stream line-by-line.  It can show progress in the
